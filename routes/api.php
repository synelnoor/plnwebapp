...
Route::resource('cabangs', 'CabangAPIController');

Route::resource('cars', 'CarAPIController');

Route::resource('statuses', 'StatusAPIController');

Route::resource('bbms', 'BbmAPIController');

Route::resource('kilometers', 'KilometerAPIController');

Route::resource('cat_bbms', 'CatBbmAPIController');

Route::resource('rfids', 'RfidAPIController');

Route::resource('vouchers', 'VoucherAPIController');

Route::resource('kategori_vouchers', 'KategoriVoucherAPIController');

Route::resource('jenis_pemakaians', 'JenisPemakaianAPIController');

Route::resource('surat_jalans', 'SuratJalanAPIController');

Route::resource('lap_surat_jalans', 'LapSuratJalanAPIController');

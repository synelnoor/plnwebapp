...
<head>
    ...
    <title>{{ isset($appName) ? $appName : 'PLN' }}</title>
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="{{ url('/dashboard') }}" class="logo">
               {{-- <b>{{ isset($appName) ? $appName : 'PLN' }}</b>
                <b  style="width:20%; heigth:auto; color:#12a2bd; font-size:30px; ">PLN</b>--}}
                <img src="{{asset('img/pln/Logo_PLN.png')}}" style="width:60%; heigth:auto; padding-top: 10px;"/>
        ...
        <footer class="main-footer{{ (Request::is('dashboard*') or Request::is('stats*')) ? ' no-side-menu' : '' }}" style="max-height: 100px;text-align: center">
            <strong>Copyright © 2019 <a href="#">PLN</a>.</strong> All rights reserved.
        </footer>
